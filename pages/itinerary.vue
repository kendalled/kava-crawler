  ...
  <div class="py-10">
    <header>
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold leading-tight text-gray-900">Your Kava Crawl Itinerary</h1>
      </div>
    </header>
    <main>
          ...
          <div class="bg-white shadow rounded-lg overflow-hidden">
            ...
            <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
              <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center">
                <div>
                  <h2 class="text-lg font-medium text-gray-900">{{ itineraryTitle }}</h2>
            ...
            <div class="p-6 border-b border-gray-200">
              ...
              <div class="mt-4 flex justify-between text-sm">
                <div>
                  ...
                  <span class="ml-1 font-medium">{{ itinerary.totalDistance }} miles</span>
                </div>
                <div>
                  <span class="text-gray-500">Estimated Duration:</span>
                  <span class="ml-1 font-medium">{{ itinerary.duration }}</span>
                </div>
                <div>
                  <a 
            ...
            <!-- Stops List -->
            <div class="px-6 py-4">
              <h3 class="text-base font-medium text-gray-900 mb-4">Your Stops</h3>
                ...
                <li v-for="(stop, index) in itinerary.stops" :key="index" class="mb-10 ml-6">
                  ...
                  <div class="p-4 bg-gray-50 rounded-lg border border-gray-200">
                    <div class="flex justify-between items-start">
                      <div>
                        <h4 class="text-lg font-semibold text-gray-900">{{ stop.name }}</h4>
                        <p class="text-sm text-gray-500">{{ stop.address }}</p>
                      </div>
                      <div class="text-right text-sm">
                        <p class="text-gray-500">Arrival: <span class="font-medium">{{ stop.arrivalTime }}</span></p>
                        <p class="text-gray-500">Stay: <span class="font-medium">{{ stop.duration }}</span></p>
                      </div>
                    </div>
                    ...
                    <div class="mt-3 text-sm">
                      <p class="text-gray-500">Hours: <span class="font-medium">{{ stop.hours }}</span></p>
                      <p v-if="stop.happyHour" class="text-gray-500">
                        Happy Hour: <span class="font-medium">{{ stop.happyHour }}</span>
                      </p>
                    </div>
                    
                    <div v-if="index < itinerary.stops.length - 1" class="mt-3 pt-3 border-t border-gray-200">
                      <div class="flex items-center text-sm">
                        <ArrowRightIcon class="h-4 w-4 text-gray-400 mr-1" />
                        <span class="text-gray-500">Next stop: {{ stop.distanceToNext }} miles ({{ stop.timeToNext }})</span>
                      </div>
                    </div>
                  </div>
                </li>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
              <h3 class="text-base font-medium text-gray-900 mb-2">Notes & Tips</h3>
